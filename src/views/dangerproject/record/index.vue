...
<!-- 危险工程监管记录 -->
  <div>
    ...
    <el-table-column
      ...
      <el-table-column width="200" align="center" header-align="center"  prop="data3" label="目前形象进度"></el-table-column>
      <el-table-column width="120" align="center" header-align="center"  prop="data4" label="管理人员数量"></el-table-column>
      <el-table-column width="120" align="center" header-align="center"  prop="data5" label="劳务人员数量"></el-table-column>
      <el-table-column width="100" align="center" header-align="center"  prop="data6" label="备注"></el-table-column>
  ...
  <el-form :model="addData"  ref="addData" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item  label="目前形象进度:" prop="data3">
                <el-input v-model="addData.data3" :disabled="disabled" placeholder="请输入目前形象进度" ></el-input>
            </el-form-item>
            <el-form-item  label="管理人员数量:" prop="data4">
                <el-input v-model="addData.data4" :disabled="disabled" placeholder="请输入管理人员数量" ></el-input>
            </el-form-item>
            <el-form-item  label="劳务人员数量:" prop="data5">
                <el-input v-model="addData.data5" :disabled="disabled" placeholder="劳务人员数量" ></el-input>
            </el-form-item>
            <el-form-item  label="备注:" prop="data6">
                <el-input v-model="addData.data6" :disabled="disabled" placeholder="请输入备注" ></el-input>
            </el-form-item>
  ...
  //下载excel
    ...
    getList() {
        ...
        var dataArr=[{
          data1: "BH54398-001",
          data2: "2019年9月第一周",
          data3: "1#楼目前为主体结构26层施工",
          data4: "45",
          data5: "200",
          data6: "本工程K2地段为整体两层地下室",
        },{
          data1: "BH54398-001",
          data2: "2019年9月第一周",
          data3: "1#楼目前为主体结构26层施工",
