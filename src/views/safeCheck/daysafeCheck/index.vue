...
<!-- 日常安全检查 -->
  <div>
    ...
    <el-table-column
      ...
      <el-table-column width="100" align="center" header-align="center"  prop="data3" label="检查人"></el-table-column>
      <el-table-column width="200" align="center" header-align="center"  prop="data4" label="检查日期"></el-table-column>
      <el-table-column width="100" align="center" header-align="center"  prop="data5" label="受检单位"></el-table-column>
