...
<!-- 定期安全检查 -->
  <div>
    ...
    <el-table-column
      ...
      <el-table-column width="100" align="center" header-align="center"  prop="data5" label="要求完成时间"></el-table-column>
      <el-table-column width="180" align="center" header-align="center"  prop="data6" label="处置措施"></el-table-column>
      <el-table-column width="120" align="center" header-align="center"  prop="data4" label="整改责任人"></el-table-column>
      <el-table-column width="120" align="center" header-align="center"  prop="data5" label="整改是否完成"></el-table-column>
      <el-table-column width="200" align="center" header-align="center"  prop="data6" label="未完成整改原因"></el-table-column>
      <el-table-column width="100" align="center" header-align="center"  prop="data5" label="复查完成情况"></el-table-column>
      <el-table-column width="100" align="center" header-align="center"  prop="data6" label="数据来源"></el-table-column>
  ...
  <el-form :model="addData"  ref="addData" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item  label="检查人:" prop="data3">
                <el-input v-model="addData.data3" :disabled="disabled" placeholder="请输入检查人" ></el-input>
            </el-form-item>
            <el-form-item  label="检查日期:" prop="data4">
                <el-input v-model="addData.data4" :disabled="disabled" placeholder="请输入检查日期" ></el-input>
            </el-form-item>
            <el-form-item  label="受检单位:" prop="data5">
                <el-input v-model="addData.data5" :disabled="disabled" placeholder="请输入受检单位" ></el-input>
            </el-form-item>
            <el-form-item  label="数据来源:" prop="data6">
                <el-input v-model="addData.data6" :disabled="disabled" placeholder="请输入数据来源" ></el-input>
            </el-form-item>
