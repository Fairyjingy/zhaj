...
<!-- 安全技术交底 -->
  <div>
    ...
    >
      <el-form-item label="期间">
        <el-input v-model="searchData.courseId" clearable  placeholder="请输入期间" ></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <el-form :model="addData"  ref="addData" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item  label="期间:" prop="data1">
                <el-input v-model="addData.data1" :disabled="disabled" placeholder="请输入期间" ></el-input>
            </el-form-item>
            <el-form-item  label="施工单位:" prop="data2">
                <el-input v-model="addData.data2" :disabled="disabled" placeholder="请输入施工单位" ></el-input>
            </el-form-item>
            <el-form-item  label="分部分项工程:" prop="data3">
                <el-input v-model="addData.data3" :disabled="disabled" placeholder="请输入分部分项工程" ></el-input>
            </el-form-item>
            <el-form-item  label="工种:" prop="data4">
                <el-input v-model="addData.data4" :disabled="disabled" placeholder="请输入工种" ></el-input>
            </el-form-item>
            <el-form-item  label="日期:" prop="data5">
                <el-input v-model="addData.data5" :disabled="disabled" placeholder="日期" ></el-input>
            </el-form-item>
            <el-form-item  label="交底人:" prop="data6">
                <el-input v-model="addData.data6" :disabled="disabled" placeholder="请输入交底人" ></el-input>
            </el-form-item>
            <el-form-item  label="状态:" prop="data7">
                <el-input v-model="addData.data7" :disabled="disabled" placeholder="请输入状态" ></el-input>
            </el-form-item>
            <el-form-item  label="确认完成情况:" prop="data8">
                <el-input v-model="addData.data8" :disabled="disabled" placeholder="请输入确认完成情况" ></el-input>
            </el-form-item>
            <el-form-item  label="数据来源:" prop="data9">
                <el-input v-model="addData.data9" :disabled="disabled" placeholder="请输入数据来源" ></el-input>
            </el-form-item>
