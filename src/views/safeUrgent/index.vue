...
<!-- 安全应急 -->
  <div>
    ...
    >
      <el-form-item label="项目应急预案">
        <el-input v-model="searchData.courseId" clearable  placeholder="请输入项目应急预案" ></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table-column
      ...
      <el-table-column width="140" align="center" header-align="center"  prop="data1" label="项目应急预案"></el-table-column>
      <el-table-column  align="center" header-align="center"  prop="data2" label="应急资源情况"></el-table-column>
  ...
  <el-form :model="addData"  ref="addData" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item  label="项目应急预案:" prop="data1">
                <el-input v-model="addData.data1" :disabled="disabled" placeholder="请输入项目应急预案" ></el-input>
            </el-form-item>
            <el-form-item  label="应急资源情况:" prop="data2">
                <el-input v-model="addData.data2" :disabled="disabled" placeholder="请输入应急资源情况" ></el-input>
            </el-form-item>
